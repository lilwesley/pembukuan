...
<html>
  <head>
    <meta charset="UTF-8">
    <title>Panel Admin - Pembukuan Blue Ducks</title>
    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="?module=beranda" class="logo">
          ...
          <span style="font-size:30px">Blue Ducks</span>
        </a>
      ...
      <footer class="main-footer">
        <strong>Copyright &copy; 2022 - <a href="main.php?module=beranda">Blue Ducks</a></strong>
      </footer>
    </div><!-- ./wrapper -->
