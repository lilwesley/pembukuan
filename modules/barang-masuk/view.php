      ...
      <div class="box box-primary">
        <div class="box-body">
          ...
          <table id="dataTables1" class="table table-bordered table-striped table-hover">
            ...
            $query = mysqli_query($mysqli, "SELECT a.kode_transaksi,a.tanggal_masuk,a.total_harga_beli,a.kode_barang,a.jumlah_masuk,a.harga_beli,b.kode_barang,b.nama_barang,b.satuan
            ...
            while ($data = mysqli_fetch_assoc($query)) { 
              ...
              echo "<tr>
                      ...
                      <td width='90' align='right'>$data[jumlah_masuk]</td>
                      <td width='80' align='right'>Rp. $harga_beli </td>
                      <td width='100' align='right'>Rp. $total_harga_beli </td>
