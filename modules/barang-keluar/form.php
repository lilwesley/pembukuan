<script type="text/javascript">
  ...
  function hitung_harga_jual() {
    bil3 = document.formObatKeluar.harga_jual.value;
    bil4 = document.formObatKeluar.jumlah_keluar.value;
    ...
    document.formObatKeluar.total_harga_jual.value = (hasil2);
  }
</script>
          ...
          <form role="form" class="form-horizontal" action="modules/barang-keluar/proses.php?act=insert" method="POST" name="formObatKeluar">
            <div class="box-body">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-5">
                  <input type="text" class="form-control" id="jumlah_kaluar" name="jumlah_keluar" autocomplete="off" onKeyPress="return goodchars(event,'0123456789',this)" onkeyup="hitung_total_stok(this)&cek_jumlah_keluar(this)&hitung_harga_jual(this)" required>
                </div>
              </div>
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label">Total Harga Jual</label>
                <div class="col-sm-5">
