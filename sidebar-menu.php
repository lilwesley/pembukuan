...
if ($_SESSION['hak_akses']=='Super Admin') { ?>
  ...
  /*// jika menu data barang keluar dipilih, menu data barang keluar aktif
  if ($_GET["module"]=="penjualan" || $_GET["module"]=="penjualan") { ?>
    <li class="active">
      <a href="?module=penjualan"><i class="fa fa-clone"></i> Order </a>
      </li>
  <?php
  }
  // jika tidak, menu data barang keluar tidak aktif
  ...
  /* // jika menu data barang keluar dipilih, menu data barang keluar aktif
  if ($_GET["module"]=="pelanggan" || $_GET["module"]=="pelanggan") { ?>
    <li class="active">
      <a href="?module=pelanggan"><i class="fa fa-clone"></i> Kelola Pelanggan </a>
      </li>
  <?php
  }
  // jika tidak, menu data barang keluar tidak aktif
