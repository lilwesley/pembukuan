      ...
      <div class="box box-primary">
        <div class="box-body">
          ...
          <table id="dataTables1" class="table table-bordered table-striped table-hover">
            ...
            $query = mysqli_query($mysqli, "SELECT kode_pelanggan,nama_pelanggan,telepon,alamat FROM is_pelanggan ORDER BY kode_pelanggan DESC")
            ...
            while ($data = mysqli_fetch_assoc($query)) { 
              ...
              echo "<tr>
                      ...
                      <td width='80' class='center'>$data[kode_pelanggan]</td>
                      <td width='180'>$data[nama_pelanggan]</td>
                      <td width='80' align='right'>$data[telepon]</td>
                      <td width='80' class='center'>$data[alamat]</td>
                      <td class='center' width='80'>
                        <div>
                          <a data-toggle='tooltip' data-placement='top' title='Ubah' style='margin-right:5px' class='btn btn-primary btn-sm' href='?module=form_pelanggan&form=edit&id=$data[kode_pelanggan]'>
                              <i style='color:#fff' class='glyphicon glyphicon-edit'></i>
                          </a>";
            ?>
                          <a data-toggle="tooltip" data-placement="top" title="Hapus" class="btn btn-danger btn-sm" href="modules/pelanggan/proses.php?act=delete&id=<?php echo $data['kode_pelanggan'];?>" onclick="return confirm('Anda yakin ingin menghapus pelanggan <?php echo $data['nama_pelanggan']; ?> ?');">
