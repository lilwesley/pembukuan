...
if (isset($_GET['tgl_awal'])) {
    ...
    $query = mysqli_query($mysqli, "SELECT a.kode_transaksi,a.tanggal_keluar,a.kode_barang,a.jumlah_keluar,a.total_harga_jual,a.harga_jual,b.kode_barang,b.nama_barang,b.satuan
            ...
            <table width="100%" border="0.3" cellpadding="0" cellspacing="0">
                <thead style="background:#e8ecee">
                    <tr class="tr-title">
                        ...
                        <th height="20" align="center" valign="middle">TOTAL HARGA JUAL</th>
...
<?php
    ...
    // jika data tidak ada
        ...
        while ($data = mysqli_fetch_assoc($query)) {
            ...
            $total_harga_jual = format_rupiah($data['total_harga_jual']);
            ...
            echo "  <tr>
                        ...
                        <td style='padding-right:10px;' width='100' height='13' align='right' valign='middle'>Rp. $harga_jual</td>
                        <td style='padding-right:10px;' width='100' height='13' align='right' valign='middle'>Rp. $total_harga_jual</td>
