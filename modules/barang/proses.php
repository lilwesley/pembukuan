...
// jika user sudah login, maka jalankan perintah untuk insert, update, dan delete
    ...
    if ($_GET['act']=='insert') {
        if (isset($_POST['simpan'])) {
            ...
            $nama_helm  = mysqli_real_escape_string($mysqli, trim($_POST['nama_barang']));
    ...
    elseif ($_GET['act']=='update') {
        if (isset($_POST['simpan'])) {
            if (isset($_POST['kode_barang'])) {
                ...
                $query = mysqli_query($mysqli, "UPDATE is_barang SET nama_barang    = '$nama_helm',
    ...
    elseif ($_GET['act']=='delete') {
        if (isset($_GET['id'])) {
            ...
            $query = mysqli_query($mysqli, "DELETE FROM is_barang WHERE kode_barang='$kode_helm'")
